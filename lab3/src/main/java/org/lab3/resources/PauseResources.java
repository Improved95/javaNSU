...
public class PauseResources implements ObjectResources {
    ...
    public void openResource(String path) {
        try (InputStream imageStream = this.getClass().getResourceAsStream("../../../SlashBladeResources/" + path)) {
            ...
            image[1][0] = fullImage.getSubimage(fullImageWidth - pauseButtonWidth, fullImageHeight - pauseButtonHeight * 1,
                    pauseButtonWidth, pauseButtonHeight);
            image[1][1] = fullImage.getSubimage(fullImageWidth - pauseButtonWidth, fullImageHeight - pauseButtonHeight * 2,
                    pauseButtonWidth, pauseButtonHeight);
            image[1][2] = fullImage.getSubimage(fullImageWidth - pauseButtonWidth, fullImageHeight - pauseButtonHeight * 3,
                    pauseButtonWidth, pauseButtonHeight);
